...
class Process_Application extends StatefulWidget {
  @override
  _Process_Application createState() => _Process_Application();
}

class _Process_Application extends State<Process_Application> {
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      DashboardScreen(parameter: "Process Application"),
  ...
  void filterByStatus(String status) {
    setState(() {
      ...
      filteredData = widget.data.where((application) {
        if (status == 'none') {
          return (application['isRecommended']==true&&application['isApproved']==true && application['isRejected']==false);
        } else {
        ...
        Theme(
          ...
          child: PaginatedDataTable(
            columns: [
              ...
              DataColumn(label: Text('Process Application Button')),
            ],
